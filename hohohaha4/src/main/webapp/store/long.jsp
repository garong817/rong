...
<body>
   <div class="row">
       <h1 class="text-center">장박 추천 용품</h1>
            ...
            <ul class="pagination">
                 <%--
                  ...
                  <c:if test="${startPage>1 }">
                    <li><a href="long.do?page=${startPage-1}">&lt;</a></li>
                 </c:if>
                 <c:forEach var="i" begin="${startPage }" end="${endPage }">
                      <li ${curpage==i?"class=active":"" }><a href="long.do?page=${i}">${i }</a></li>
                 </c:forEach>
                 <c:if test="${endPage<totalpage }">
                    <li><a href="long.do?page=${endPage+1}">&gt;</a></li>
                 </c:if>
               </ul>
       </div>
     </div>
