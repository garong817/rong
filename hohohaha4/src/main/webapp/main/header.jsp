                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="shop.html" class="nav-item nav-link">캠핑예약</a>
                            <!-- <a href="shop-detail.html" class="nav-item nav-link">Shop Detail</a> -->
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">캠핑용품</a>
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <a href="../store/store_main.do" class="dropdown-item">신규등록상품</a>
                                    <a href="chackout.html" class="dropdown-item">백패킹/하이킹</a>
                                    <a href="testimonial.html" class="dropdown-item">장박추천용품</a>
                                    <a href="404.html" class="dropdown-item">여행용품</a>
                                </div>
                            </div>
