...
public class StoreModel {
   ...
   public String store_detailex(HttpServletRequest request, HttpServletResponse response)
   {
       ...
       GoodsVO vo=dao.goodsDetailData(Integer.parseInt(cno),Integer.parseInt(gno));
       request.setAttribute("vo", vo);
       request.setAttribute("main_jsp","../store/detailex.jsp");
       
       return "../main/main.jsp";
   }
   @RequestMapping("store/store_main.do")
   public String store_main(HttpServletRequest request, HttpServletResponse response)
   {
